...
class StatementsControllerTest < ActionController::TestCase
  ...
  test "should create statement" do
    assert_difference('Statement.count') do
      post :create, statement: { depth: @statement.depth, full_text: @statement.full_text, room_id: @statement.room_id, user_id: @statement.user_id }
    end
  ...
  test "should update statement" do
    patch :update, id: @statement, statement: { depth: @statement.depth, full_text: @statement.full_text, room_id: @statement.room_id, user_id: @statement.user_id }
    assert_redirected_to statement_path(assigns(:statement))
  end
